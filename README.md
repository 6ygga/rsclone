...
О курсах узнал от коллеги по работе. Изначально проходил курс RSS React 2020 Q1. После прохождения данного курса, понял что не хватает знаний по javascript, поэтому сразу записался на текущий курс.

На втором этапе возникали сложности с не хваткой времени, т. к. приходилось одновременно изучать новые темы и выполнять задания. Так же сложности возникали с командными тасками из-за отсутствия опыта работы в команде.

Во время обучения выполнил все задания. Из наиболее интересных тасков можно выделить пятнашки, english for kids, covid dashboard.
...
FrontEnd:
- Реализовано 3+ анимации, для создания которых используются ключевые кадры
